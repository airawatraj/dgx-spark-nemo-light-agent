...
# ///
"""
DGX Spark / Nemotron-3.5-Lightning-30B Smarts Benchmark
Runs tool-eval-bench in the common modes used for short checks, throughput,
and deterministic multi-trial evaluation.
...
def main():
    parser = argparse.ArgumentParser(
        description="Run tool-eval-bench against the local Cogni-Brain vLLM endpoint.",
        epilog=(
    ...
    header("SMARTS BENCHMARK — NVIDIA-Nemotron-3.5-Lightning-30B-A3B-NVFP4 + DSpark (Cogni-Brain)")
